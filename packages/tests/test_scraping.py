...
def test_scraping(
    ...
    **Args:**
        ...
        url : str 
            Google images url (The url when searching in Google the term you are interested about and then chooses images).
        max_images : int 
            Maximum number of images to scrape.
        timestamp_list : List[str] 
            List of timestamps.
        delay : float, optional 
            Delay between button clicks and scrolling. Defaults to 0.8.
    """
